...
interface FullDocumentationProps {
  className?: string;
  activeSection?: string;
}

const FullDocumentation: React.FC<FullDocumentationProps> = ({ 
  className = '',
  ...
  return (
    <div className={`documentation-section ${className}`} ref={contentRef}>
            ...
            <div className="space-y-8">
              {section.images.map((imageIndex) => (
                <div key={imageIndex} className="documentation-image">
                  ...
                  >
                    <Image
                      src={`/documentation_layout/image${imageIndex}.png`}
