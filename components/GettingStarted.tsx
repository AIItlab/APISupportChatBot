  ...
  useEffect(() => {
    const drawDiagram = () => {
      ...
      steps.forEach((step, index) => {
        ...
        // Box gradient
        const boxGradient = ctx.createLinearGradient(x - boxWidth/2, y, x - boxWidth/2, y + boxHeight);
        ...
        // Box border
        const borderGradient = ctx.createLinearGradient(x - boxWidth/2, y, x - boxWidth/2, y + boxHeight);
        ...
        if (index < steps.length - 1) {
          ctx.save();
          const gradient = ctx.createLinearGradient(x, y + boxHeight, x, y + boxHeight + verticalGap);
