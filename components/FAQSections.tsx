...
export const FAQList: FAQ[] = [
  ...
  },
  {
    ...
    category: 'advanced',
    subcategory: 'Integration',
    question: "I am getting the error message 'nREDACTED:DuplicateLeg, Segment already booked'. How can I solve it?",
    answer: (
      <>
    ...
    answer: (
      <>
        ...
        <ul className="list-disc pl-4 mt-2">
          ...
          <li>Implement REDACTED for better performance</li>
        </ul>
