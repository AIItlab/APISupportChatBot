...
export const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <>
          <p>Using BookingQuote API, baggage allowance can be found in response under the field "baggageAllowanceWeight" which represents allowed baggage. Example: "2PC,30KG" means piece allowance of 30 Kg maximum in each one of the 2 pieces.</p>
